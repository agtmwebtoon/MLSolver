...
void Materials::declare_parameters(ParameterHandler &prm) {
    prm.enter_subsection("Material properties");
    {
        prm.declare_entry("Poisson's ratio", "0.4999",
                          Patterns::Double(-1.0, 0.5), "Poisson's ratio");
...
void LinearSolver::declare_parameters(ParameterHandler &prm) {
    prm.enter_subsection("Linear solver");
    {
        ...
        prm.declare_entry("Use static condensation", "true", Patterns::Bool(),
...
// (Implementations for Materials, LinearSolver, NonlinearSolver, Time)
